  ...
  return (
    <div className="home">
      ...
      <section className="hero">
        ...
        <p>
          Find the perfect tutor or student with EduBondhu’s seamless platform. Connect, chat,
      ...
      <section className="features">
        ...
        <p>
          EduBondhu offers a comprehensive suite of tools to enhance the learning experience
        ...
        <div className="feature-cards">
          <div className="card">
            ...
            <p>
              Search for tutors based on subject, level, and availability. Our advanced
              search filters ensure you find the perfect match.
            </p>
          </div>
          <div className="card">
            <h4>Seamless Communication</h4>
            <p>
              Communicate with tutors directly through our integrated chat system. Schedule
              sessions, ask questions, and stay connected.
            </p>
          </div>
          <div className="card">
      ...
      <section className="final-cta">
        ...
        <p>
          Join EduBondhu today and unlock your full potential. Whether you're a student seeking
